        ...
        <footer>
            ...
            <div className="footer p-10 bg-neutral text-neutral-content ">
                <aside>
                    ...
                    <p>Bistro Boss<br />Providing reliable tech since 1992</p>
                </aside>
                <nav className="">
            ...
            <div className="footer items-center footer-center bg-base-300 p-4 text-black  ">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Copyright © 2024 - All right reserved by- Sifat Sadiq</p>
                </aside>
